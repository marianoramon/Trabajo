Sub Main()
    ...
    ' PLEGADO v10.18 - pregunta e inserta rotulo COD PLEG
    ' Layout normalizado segun planos correctos A4/A3.
    ' Las vistas longitudinales y el detalle de extremo usan escalas independientes.
    ' Evita planos A3 dispersos a 1:30 por validar la longitud en la zona lateral.
    ' Orden A3: tres vistas longitudinales arriba; detalle e isometricas abajo.
    ' Patron A3: detalle completo a la derecha e isometricas escalonadas abajo.
